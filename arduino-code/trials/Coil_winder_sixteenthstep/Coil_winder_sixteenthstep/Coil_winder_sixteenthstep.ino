...
// M0,M1 Y M2 HIGH (Todos los jumpers puestos)
// Va muy lento, cabecea solo
// Con éste código el devanado es uniforme, pero muy lento.
// Una opción sería utilizar full step pero con un nozzle o extrusor que dirija el hilo para que no se mueva al ir más rápido
int step_x = 2;
int dir_x = 5;
int enable = 8;
int step_y = 3;
